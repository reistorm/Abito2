                                ...
                                <div className="content-side__box">
                                    <div className="content-side__list">
                                        <div className="content-side__list-item">
                                            <img className="content-side__list-item--img" src="/img/shipping.svg" alt="shipping" />
                                        ...
                                        <div className="content-side__list-item">
                                            <img className="content-side__list-item--img" src="/img/002-sedan 1.svg" alt="sedan" />
                                        ...
                                        <div className="content-side__list-item">
                                            <img className="content-side__list-item--img" src="/img/love 1.svg" alt="love1" />
